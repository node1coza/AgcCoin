...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        CoinControlDialog->setStyleSheet(QStringLiteral("background-image: url(:/images/2b);"));
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 agc"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 agc"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 agc"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 agc"));
