...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        RPCConsole->setStyleSheet(QStringLiteral("background-image: url(:/images/2b);"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "agcCOIN - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "agcCOIN Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the agcCOIN debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the agcCOIN-Qt help message to get a list with possible agcCOIN command-line options.", 0));
#endif // QT_NO_TOOLTIP
