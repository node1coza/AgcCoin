...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MintingFilterProxy_t, stringdata) + ofs \
...
const QMetaObject MintingFilterProxy::staticMetaObject = {
    { &QSortFilterProxyModel::staticMetaObject, qt_meta_stringdata_MintingFilterProxy.data,
      qt_meta_data_MintingFilterProxy,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MintingFilterProxy.stringdata))
