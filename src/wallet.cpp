...
// agccoin: total coins staked (non-spendable until maturity)
...
// agccoin: get current stake weight
...
// agccoin: check 'spent' consistency between wallet and txindex
// agccoin: fix wallet spent state according to txindex
...
// agccoin: disable transaction (only for coinstake)
