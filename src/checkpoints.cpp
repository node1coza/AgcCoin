...
namespace Checkpoints
{
    ...
    // agccoin: synchronized checkpoint (centrally broadcasted)
    ...
    // agccoin: get last synchronized checkpoint
    ...
    // agccoin: only descendant of current sync-checkpoint is allowed
    ...
    // agccoin: reset synchronized checkpoint to last hardened checkpoint
...
// agccoin: sync-checkpoint master key
...
// agccoin: verify signature of sync-checkpoint message
...
// agccoin: process synchronized checkpoint
