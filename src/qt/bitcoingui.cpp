    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("agcCOIN") + " - " + tr("Wallet"));
#ifdef Q_OS_LINUX
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a agcCOIN address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About agcCOIN"), this);
    aboutAction->setToolTip(tr("Show information about agcCOIN"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for agcCOIN"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("background-color: #2CDF96; color: white");
#else
    //Windows/Mac - Set Purple tabs, white text, tooltips adjusted
    toolbar->setStyleSheet(" QToolTip { color: black; background-color: #2CDF96}; color: white; background-color: #2CDF96");
#endif
...
#ifdef Q_OS_LINUX
    //Linux - Set Purple tabs, white text, tooltips unaffected
    toolbar2->setStyleSheet("background-color: #2CDF96");
#else
    //Windows/Mac - Set Purple tabs, tooltips adjusted
    toolbar2->setStyleSheet(" QToolTip { color: black; background-color: #2CDF96}; background-color: #2CDF96");
#endif
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("agcCOIN client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("agcCOIN client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to agcCOIN network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid agcCOIN address or malformed URI parameters."));
    }
